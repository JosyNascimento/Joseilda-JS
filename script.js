...
const properties = [
  {
    ...
    price: "R$ 750.000,00",
    image:
      "https://imgs.search.brave.com/g3JR15toxKEuAaocxuM9oExCtsxHQTZLjY8Hvrw1KVM/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzL2I3LzUy/L2YwL2I3NTJmMDAy/MzA0MzEyNDIzZDkx/MzZhM2E1ZWM4ZjMz/LmpwZw",
  },
  {
    id: 2,
    ...
    image:
      "https://imgs.search.brave.com/EIzP0RUI8RzF-MXhkI00M0Z5E1Sb1RADEE_-AwiR3p8/rs:fit:500:0:0/g:ce/aHR0cDovL2ltYWdl/cy5hcnF1aWRpY2Fz/LmNvbS5ici93cC1j/b250ZW50L3VwbG9h/ZHMvMjAxNS8wMi8x/MTE5MDMzMC9jYXNh/LWhpZ2gtdGVjaC5q/cGc",
  },
  {
    id: 3,
...

  {
    ...
    price: "R$ 850.000,00",
    image:
      "https://imgs.search.brave.com/mV7xGsj8Urw3J1r8Sf6-b7o5GsIaKQZUo6mz0M8TGI8/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9jb25z/dHJ1aW5kb2RlY29y/LmNvbS5ici93cC1j/b250ZW50L3VwbG9h/ZHMvMjAxNy8wOC9j/YXNhLWFtZXJpY2Fu/YS5qcGc",
  },
  {
    id: 5,
    title: "Apartamento com vista para o mar",
    ...
    price: "R$ 1.200.000,00",
    image:
      "https://imgs.search.brave.com/p04EGGctu0s4SsbzG8nUtZzwJ3GXv6ZLHRnSXpA76Es/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9jb25z/dHJ1aW5kb2RlY29y/LmNvbS5ici93cC1j/b250ZW50L3VwbG9h/ZHMvMjAxMi8xMi90/ZW5kZW5jaWEtZGUt/ZGVjb3JhY2FvLWRl/LWFwYXJ0YW1ldG5v/LmpwZw",
  },
];
...
function calcularFinanciamento() {
  ...
  const taxaJurosAnual =
    parseFloat(document.getElementById("taxa-juros").value) / 100;
  ...
  if (taxaJurosAnual <= 0 || numeroParcelas <= 0) {
    alert(
      "A taxa de juros e o número de parcelas devem ser valores positivos."
    );
    return;
  }
  ...
  const prestacaoMensal =
    ...
    (1 - Math.pow(1 + taxaJurosMensal, -numeroParcelas));
  ...
  resultadoDiv.innerHTML = `
        <p><strong>Valor Financiado:</strong> R$ ${valorFinanciado.toFixed(
          2
        )}</p>
        <p><strong>Taxa de Juros Mensal:</strong> ${(
          taxaJurosMensal * 100
        ).toFixed(2)}%</p>
        <p><strong>Número de Parcelas:</strong> ${numeroParcelas}</p>
        <p><strong>Valor da Prestação Mensal:</strong> R$ ${prestacaoMensal.toFixed(
          2
        )}</p>
...
fecharResultadoBtn.addEventListener("click", () => {
  resultadoDiv.style.display = "none"; // Oculta o modal
